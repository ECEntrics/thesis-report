...
The developed proof of concept application "Concordia" approaches the above goal by combining Ethereum and IPFS, in order to create a digital space, that is decentralized both at architectural and political level. 
\\[2\baselineskip]
